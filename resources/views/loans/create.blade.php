...
@endisset
    ...
    <div class="layout">
        ...
        {{ ('طلب استعارة' ) }} <span class="qout" style="color: red;margin-right:17px"> " </span> <span class="title" style="color:green;"> {{$book->title}}</span>  <span class="qout" style="color: red;">"</span>
        </span>
    ...
    <div class="container-login100-form-btn">
            ...
            <a href="{{ route('loans.store', ['book' => $book->id]) }}" style="color: white;">حفظ</a>
			</button>
    </div>
            </form>
	...
	<div class="container-login100-form-btn">
            ...
            <a href="{{route('book.index')}}"style="color: white;">الغاء</a>
			</button>
	</div>
</div>
...
<script>
    ...
    function ondataChanage(e) {
        return; // to skip this whole validation shit :)
...

        {
            ...
            sendButton.innerHTML = "<a id='send-button' href='{{ route('loans.store', ['book' => $book->id]) }}'>حفظ</a>";
        }
    }
