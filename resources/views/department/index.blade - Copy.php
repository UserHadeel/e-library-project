            ...
            <table class="styled-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="{{ route('department.destroy', $department->name) }}" method="POST" onsubmit="return confirm('هل أنت متأكد أنك تريد حذف هذا القسم ؟')">
                                @method('DELETE')
                                @csrf
...
<div class="popup"  id="divID" style="display: none;">
    ...
    <div class="ppp-content">
        ...
        <div class="p3c-input-element">
            ...
            <div class="col-75">
            <input class="inpt" type="text" id="myInputTag" name="name" ></div>
    ...
    <script>
        function save_click(e) {
            ...
            let button=this;
            fetch('/updated/'+document.querySelector('#myIDHere').value, {
                method: 'post',
