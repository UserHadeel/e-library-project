...
<h1 class="category-title">
    <span class="Title"><h2>إنشاء صلاحية جديدة</h2></span>
 </h1>
        ...
        @csrf
          <div class="col-xs-12 col-sm-12 col-md-12">
             ...
             <div class="form-group">
               ...
               <strong style="font-size: 20px;font-family:'Times New Roman', Times, serif">الأسم:</strong>
                 <input  class="inpt" type="text" name="name" required placeholder="إسم الصلاحية">
          ...
          <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            <div class="form-group">
              ...
              <strong style="font-size: 20px;font-family:'Times New Roman', Times, serif">الأذونات:</strong><br/>
              <br/>
