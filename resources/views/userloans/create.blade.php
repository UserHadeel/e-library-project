...
@endisset
    ...
    <div class="layout">
            ...
            <form method="POST" action="{{ route('userloans.store', ['book' => $book->id]) }}">
            @csrf
        <span class="login100-form-title">
        {{ ('طلب استعارة' ) }} <span style="color:red; margin-right:17px;font-family: Poppins-Regular, sans-serif;"> " </span> <span class="title" style="color:green;"> {{$book->title}}</span>  <span style="color: red;font-family: Poppins-Regular, sans-serif;">"</span>
        </span>
    ...
    <div class="container-login100-form-btn">
            ...
            <a href="{{ route('userloans.store', ['book' => $book->id]) }}" style="color: white;">حفظ</a>
			</button>
    </div>
            </form>
	...
	<div class="container-login100-form-btn">
            ...
            <a href="{{route('homepage')}}"style="color: white;">الغاء</a>
			</button>
	</div>
...
<script>
    ...
    function ondataChanage(e) {
...

        {
            ...
            sendButton.innerHTML = "<a id='send-button' href='{{ route('userloans.store', ['book' => $book->id]) }}'>حفظ</a>";
        }
    }
